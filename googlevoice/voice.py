...
class Voice(object):
    ...
    def login(self, email=None, passwd=None, smsKey=None, b64Masked=False):
        """
        ...
        -- Added function to mask parameters using b64 module prior if parameter b64Masked=True. atangeman20150105
        -- prevets passwords from being leaked unintentionally
        """
        if hasattr(self, '_special') and getattr(self, '_special'):
            return self
